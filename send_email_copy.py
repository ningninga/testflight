...
def send_email(mail_receivers, subject_content, body_content):
    ...
    # 发件人邮箱
    mail_sender = "jingjianing0317@163.com"
    # 邮箱授权码,注意这里不是邮箱密码,如何获取邮箱授权码,请看本文最后教程
    mail_license = "FHUEHAPNREDJDVZF"

    mm = MIMEMultipart('related')

    # 设置发送者,注意严格遵守格式,里面邮箱为发件人邮箱
    mm["From"] = "sender_name<jingjianing0317@163.com>"
...
if __name__ == '__main__':
    send_email(["gabbyjing@163.com", "983176666@qq.com"], "???????!!!!!", "text")